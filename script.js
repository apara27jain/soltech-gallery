...
const PROJECT_GALLERIES = {
  ...
  "maheshwari-public-school":            { name: "Maheshwari Public School",  meta: "220 kW · Jaipur, Rajasthan", photos: Array.from({length: 1}, (_, i) => `maheshwari-public-school/photo-${i+1}.jpg`) },
  "vinayak-industries":                  { name: "Vinayak Industries",    meta: "200 kW · Jaipur, Rajasthan",    photos: Array.from({length: 1}, (_, i) => `vinayak-industries/photo-${i+1}.jpg`)  },
  "hastakala":                           { name: "Hastakala",    meta: "200 kW · Jaipur, Rajasthan",   photos: Array.from({length: 1}, (_, i) => `hastakala/photo-${i+1}.jpg`) },
  "surface":                             { name: "Surface",    meta: "150 kW · Jaipur, Rajasthan",    photos: Array.from({length: 1}, (_, i) => `surface/photo-${i+1}.jpg`) },
  "shakun-marble-134":                   { name: "Shakun Marble",    meta: "134 kW · Jaipur, Rajasthan",    photos: Array.from({length: 1}, (_, i) => `shakun-marble-134/photo-${i+1}.jpg`)  },
  "jajoo-exim":                          { name: "Jajoo Exim Pvt. Ltd.",    meta: "120 kW · Jaipur, Rajasthan",    photos: Array.from({length: 1}, (_, i) => `jajoo-exim/photo-${i+1}.jpg`)  },
